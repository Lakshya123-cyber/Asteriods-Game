...
const LASER_SPD = 500; // speed of laser in pixels per second pewpew
...
const SAVE_KEY_SCORE = "highscore"; // save key fo local storage of high score
...
function keyDown( /** @type {KeyBoardEvent} */ ev) {
  ...
  switch (ev.keyCode) {
    case 32: // space bar (shoot lasers pewpew)
      shootLaser();
      break;
...
function update() {
  ...
  if (textAlpha >= 0) {
    ...
    ctx.font = "small-caps " + TEXT_SIZE + "px Fira Code";
  ...
  ctx.textBaseline = "middle";
  ctx.fillStyle = "white";
  ctx.font = TEXT_SIZE + "px Fira Code";
  ...
  ctx.textBaseline = "middle";
  ctx.fillStyle = "white";
  ctx.font = (TEXT_SIZE * 0.75) + "px Fira Code";
